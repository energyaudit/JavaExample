...
public class MongoExp2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("\n3. Find when number = 2 and name = 'Billy-2' example");
            BasicDBObject andQuery = new BasicDBObject();

            List<BasicDBObject> obj = new ArrayList<BasicDBObject>();
            obj.add(new BasicDBObject("number", 2));
            obj.add(new BasicDBObject("name", "Billy-2"));
            ...
            regexQuery.put("name",
                    new BasicDBObject("$regex", "Bil.*-[1-3]")
                            .append("$options", "i"));
