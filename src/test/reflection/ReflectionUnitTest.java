...
import main.Java0.Bird;
import main.Java0.Goat;
import main.Java0.PersonReflection;
...
public class ReflectionUnitTest {
    ...
    public void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        final Object person = new PersonReflection();
    ...
    public void givenObject_whenGetsClassName_thenCorrect() {
        ...
        assertEquals("main.Java0.Goat", clazz.getName());
        assertEquals("main.Java0.Goat", clazz.getCanonicalName());
    }

    @Test
    public void givenClassName_whenCreatesObject_thenCorrect() throws ClassNotFoundException {
        final Class<?> clazz = Class.forName("main.Java0.Goat");
    ...
    public void givenClass_whenRecognisesModifiers_thenCorrect() throws ClassNotFoundException {
        final Class<?> goatClass = Class.forName("main.Java0.Goat");
        final Class<?> animalClass = Class.forName("main.Java0.Animal");
    ...
    public void givenClass_whenGetsPackageInfo_thenCorrect() {
        ...
        assertEquals("main.Java0", pkg.getName());
    }
    ...
    public void givenClass_whenGetsConstructor_thenCorrect() throws ClassNotFoundException {
        ...
        assertEquals("main.Java0.Goat", constructors[0].getName());
    }
    ...
    public void givenClass_whenGetsAllConstructors_thenCorrect() throws ClassNotFoundException {
        final Class<?> birdClass = Class.forName("main.Java0.Bird");
    ...
    public void givenClassField_whenGetsType_thenCorrect() throws Exception {
        final Field field = Class.forName("main.Java0.Bird").getDeclaredField("walks");
